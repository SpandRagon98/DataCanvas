  ...
  return (
    ...
    >
      ...
      >
        ...
        {!CLOUD_ENABLED && (
          <div className="rounded-xl border px-3 py-3 text-xs" style={{ background: "rgba(245,158,11,0.08)", borderColor: "rgba(245,158,11,0.22)", color: T.accent }}>
        ...
        {CLOUD_ENABLED && (
          <div className="space-y-3">
                ...
                {[["never","Never"],["7","7 days"],["30","30 days"]].map(([v, l]) => (
                  <button
                    ...
                    style={{
                      ...
                      borderColor: expiry === v ? "rgba(245,158,11,0.28)" : T.border,
            ...
            {!workbookId && (
              <div className="rounded-xl border px-3 py-2 text-xs" style={{ background: "rgba(245,158,11,0.08)", borderColor: "rgba(245,158,11,0.22)", color: T.accent }}>
