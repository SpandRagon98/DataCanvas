...
const CheckboxSetFilter = forwardRef(function CheckboxSetFilter(props, ref) {
  ...
  const s = {
    ...
    actionBtn:  { color: "var(--dc-accent)", cursor: "pointer", background: "none", border: "none", padding: 0, fontWeight: 600 },
    ...
    checkbox:   { cursor: "pointer", accentColor: "var(--dc-accent)", flexShrink: 0 },
